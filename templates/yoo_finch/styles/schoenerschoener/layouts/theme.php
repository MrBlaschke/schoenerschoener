...
<!--                   <div class="uk-flex uk-flex-middle uk-navbar-content tm-menu-button uk-visible-large" data-uk-dropdown="{mode:'click'}">
                       ...
                       <div class="uk-visible-large uk-button" style="border: none;">
                       <?php echo $this['widgets']->render('menu-button'); ?>
                       </div>
   ...
   <div id="tm-top-a" class="uk-block tm-block-top-a <?php echo @$block_classes['top-a']; echo @$display_classes['top-a']; ?>" <?php echo $styles['block.top-a']; ?>>
    ...
    <?php if ($this['widgets']->count('top-a-handy')) : ?>
    <div id="tm-top-a-handy" class="uk-block tm-block-top-a <?php echo @$block_classes['top-a-handy']; echo @$display_classes['top-a-handy']; ?>" <?php echo $styles['block.top-a-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('top-a-handy', array('layout'=>$this['config']->get('grid.top-a-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('top-b-handy')) : ?>
    <div id="tm-top-b-handy" class="uk-block tm-block-top-b-handy <?php echo @$block_classes['top-b-handy']; echo @$display_classes['top-b-handy']; ?>" <?php echo $styles['block.top-b-handy']; ?>>
         <div class="uk-container uk-container-center ">
             <section class="uk-panel " >
                 <?php echo $this['widgets']->render('top-b-handy', array('layout'=>$this['config']->get('grid.top-b-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('top-c-handy')) : ?>
    <div id="tm-top-c-handy" class="uk-block tm-block-top-c <?php echo @$block_classes['top-c-handy']; echo @$display_classes['top-c-handy']; ?>" <?php echo $styles['block.top-c-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('top-c-handy', array('layout'=>$this['config']->get('grid.top-c-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
   ...
   <?php if ($this['widgets']->count('top-d')) : ?>
    ...
    <?php if ($this['widgets']->count('top-d-handy')) : ?>
    <div id="tm-top-d-handy" class="uk-block tm-block-top-d <?php echo @$block_classes['top-d-handy']; echo @$display_classes['top-d-handy']; ?>" <?php echo $styles['block.top-d-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('top-d-handy', array('layout'=>$this['config']->get('grid.top-d-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('bottom-a-handy')) : ?>
    <div id="tm-bottom-a-handy" class="uk-block tm-block-bottom-a <?php echo @$block_classes['bottom-a-handy']; echo @$display_classes['bottom-a-handy']; ?>" <?php echo $styles['block.bottom-a-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('bottom-a-handy', array('layout'=>$this['config']->get('grid.bottom-a-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('bottom-b-handy')) : ?>
    <div id="tm-bottom-b-handy" class="uk-block tm-block-bottom-b <?php echo @$block_classes['bottom-b-handy']; echo @$display_classes['bottom-b-handy']; ?>" <?php echo $styles['block.bottom-b-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('bottom-b-handy', array('layout'=>$this['config']->get('grid.bottom-b-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('bottom-c-handy')) : ?>
    <div id="tm-bottom-c-handy" class="uk-block tm-block-bottom-c <?php echo @$block_classes['bottom-c-handy']; echo @$display_classes['bottom-c-handy']; ?>" <?php echo $styles['block.bottom-c-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('bottom-c-handy', array('layout'=>$this['config']->get('grid.bottom-c-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
    ...
    <?php if ($this['widgets']->count('bottom-d-handy')) : ?>
    <div id="tm-bottom-d-handy" class="uk-block tm-block-bottom-d <?php echo @$block_classes['bottom-d-handy']; echo @$display_classes['bottom-d-handy']; ?>" <?php echo $styles['block.bottom-d-handy']; ?>>
         <div class="uk-container uk-container-center">
             <section class="uk-panel" >
                 <?php echo $this['widgets']->render('bottom-d-handy', array('layout'=>$this['config']->get('grid.bottom-d-handy.layout'))); ?>
             </section>
         </div>
     </div>
     <?php endif; ?>
